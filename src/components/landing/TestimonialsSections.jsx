...
const TestimonialsSections = ({testimonials}) => {
  return (
     <div className="py-20 bg-white overflow-hidden">
      <div className="relative max-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="p-8">
                  <div className="flex items-center">
                    <div className="flex-shrink-0 h-12 w-12">
                              <img src={testimonial.image} alt={testimonials.name} className='h-12 w-12 rounded-full' />
                    </div>
                    <div className="ml-4">
                      <h4 className="text-lg font-bold test-gray-900">
                        {testimonial.name}
                      </h4>
